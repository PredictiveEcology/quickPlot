...
vignette: >
  ...
  %\VignetteDepends{data.table, grDevices, magrittr, RColorBrewer, quickPlot, stats}
...
library(data.table)
library(magrittr)
if (!require("raster")) stop("This vignette requires the raster package: install.packages('raster')") 
library(quickPlot)
